...
class HospitalReservationPageBody extends StatelessWidget {
  const HospitalReservationPageBody({Key? key}) : super(key: key);
    ...
    return ListView.separated(
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: InkWell(
            onTap: () {
              Navigator.pushNamed(context, Move.hospitalReservationDetailPage);
            },
            child: Container(
